...
SYMBOL             = "TSLA"
INITIAL_QTY        = 10
INITIAL_ENTRY_ID   = "b74249cf-9fc3-4476-8b78-3202a5d2adad"
...
def run_one_cycle():
    ...
    try:
        ...
        log_event("errors", "strategy.py", "no_state_file",
    ...
    if state.get("position_qty", 0) == 0:
        ...
        log_event("tsla", "strategy.py", "cycle_skipped_no_position",
    ...
    try:
        ...
        _save_state(state)
        log_event("tsla", "strategy.py", "cycle_complete",
                  result="success",
        ...
        send_embed(
            "errors", "strategy.py — exception in run_one_cycle",
            color=Color.RED,
            description=f"`{type(e).__name__}: {str(e)[:500]}`",
            footer="strategy.py",
        )
